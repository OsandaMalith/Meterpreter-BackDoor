...
#Usage
def usage
  print_line("Windows Backdoor- Sneaks a Backdoor Command Shell in place of Sticky Keys Prompt or Utilman assistant at Login Screen (requires admin privs)")
...
if remove.to_i > 0
  print_status("Starting the cleanup process.....")
...
# All done, peace out!
print_status("Finished Backdoor!")
if remove.to_i > 0
